...
import { determineResolutionMode } from '../../../packages/core/src/utils/resolution-mode.js';
import { validateResolutionFlags } from '../../../packages/core/src/core/install/validators/index.js';
